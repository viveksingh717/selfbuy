                        ...
                        <div class="card-body">
                            <div class="d-md-flex justify-content-between mb-2">
                                <ul class="nav nav-tabs b-none">
                                    <li class="nav-item">
                                        <a class="nav-link active" href="{{ route('admin.create_size') }}">Add Size</a>
                                    </li>
                                    <li class="nav-item">
                ...
                <div class="col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form name="sizeForm" class="card-body" id="sizeForm" method="POST">
                                ...
                                <div class="row clearfix">
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            @foreach ($sizeGroups as $groupName => $sizes)
                                ...
                                <div class="row clearfix mt-3">
                                    <div class="col-sm-12">
                                        <button type="submit" class="btn btn-primary" id="size_form_submit">Submit</button>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.querySelectorAll('.size-chip').forEach(function(chip) {
                ...
                // reset chip highlight when form reset is clicked
