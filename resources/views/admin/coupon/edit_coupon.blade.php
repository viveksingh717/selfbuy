                        ...
                        <div class="card-body">
                            <div class="d-md-flex justify-content-between mb-2">
                                <ul class="nav nav-tabs b-none">
                                    <li class="nav-item">
                                        <a class="nav-link active" href="{{ route('admin.edit_coupon', $coupon->id) }}">
                                            Edit Coupon
                                        </a>
                                    </li>
                                    <li class="nav-item">
                ...
                <div class="col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form name="editCouponForm" class="card-body" id="editCouponForm">
                                    ...
                                    <div class="col-md-4 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="coupon_name" id="coupon_name"
                                                placeholder="e.g. Summer Sale 20%" value="{{ $coupon->coupon_name }}">
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="form-control" name="coupon_code"
                                                    ...
                                                    style="text-transform:uppercase;" value="{{ $coupon->coupon_code }}">
                                    ...
                                    <div class="col-12">
                                        <div style="display:flex; flex-wrap:wrap; gap:10px;">
                                            ...
                                            @foreach ($discountTypes as $type)
                                                @php $isActive = $coupon->discount_type === $type['value']; @endphp
                                                <div class="discount-type-card {{ $isActive ? 'active' : '' }}"
                                ...
                                <div id="discountValueSection"
                                    style="{{ $coupon->discount_type === 'free_shipping' ? 'display:none;' : '' }}">
                                    <h6 class="text-muted font-weight-bold mb-3"
                                        style="font-size:11px; text-transform:uppercase; letter-spacing:.06em;">
                                        Discount Value
                                    </h6>
                                    <div class="row clearfix">
                                        <div class="col-md-4 col-sm-12">
                                            <div class="form-group">
                                                <label>
                                                    Discount Value
                                                    <span class="badge badge-info ml-1" id="discountBadge">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <div class="input-group-append">
                                                        <span class="input-group-text" id="discountAddon">
                                                            {{ $coupon->discount_type === 'percentage' ? '%' : '₹' }}
                                                        </span>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="col-md-8 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="description" id="description" rows="2"
                                                placeholder="e.g. Diwali sale coupon for first-time buyers">{{ $coupon->description }}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="applicable_to" id="applicable_to">
                                                <option value="all"
                                                    {{ $coupon->applicable_to === 'all' ? 'selected' : '' }}>All
                                                    Products</option>
                                                <option value="category"
                                                    {{ $coupon->applicable_to === 'category' ? 'selected' : '' }}>Specific
                                                    Category</option>
                                                <option value="product"
                                                    {{ $coupon->applicable_to === 'product' ? 'selected' : '' }}>Specific
                                                    Product</option>
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="row clearfix mt-3">
                                    <div class="col-sm-12">
                                        <button type="submit" class="btn btn-primary"
                                            id="coupon_editform_submit">Update</button>
...
@section('script')
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // ── Force coupon code uppercase while typing ───────────
            ...
            // ── Set expiry min on load from existing start date ───
